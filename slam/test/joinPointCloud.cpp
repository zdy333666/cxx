...
//    cout << "frame1.rgb" << frame1.rgb.size() << endl;
...
//    cout << "detecter:" << detecter << endl;
    ...
    Eigen::Translation<double, 3> trans(result.tvec.at<double>(0, 0), result.tvec.at<double>(0, 1),
