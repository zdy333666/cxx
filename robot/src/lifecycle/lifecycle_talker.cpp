...
public:
     ...
     */
    explicit LifecycleTalker(const std::string &node_name, bool intra_process_comms = false) : rclcpp_lifecycle::LifecycleNode(node_name, "", intra_process_comms) {}
    ...
    void publish() {
        ...
        if (!pub_->is_activated()) {
            ...
            RCLCPP_INFO(get_logger(), "Lifecycle publisher is active. Publishing: [%s]", msg_->data.c_str());
        }
